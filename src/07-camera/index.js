...
function init() {
  ...
  // ];
	...
	urls.slice( 1 );
  	console.log(urls)
	  //CubeTextureをロードするためのクラス。これは、ファイルのロードに内部的にImageLoaderを使用します。
	...
	var count = 0;
		...
		var mesh = new THREE.Mesh( geo, new THREE.MeshBasicMaterial( parameters ) );
	...
	function initPostprocessing() {
      ...
      // 何度もレンダリングする時につかう
			...
			function render() {
				...
				// 	}
				// }
				materials[ 0 ].color.setHSL( 30, 1, 0.5 );
